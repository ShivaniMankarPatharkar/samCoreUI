...
export default class AddTrainee extends Component {
  constructor(props) {
    ...
    this.onChangeTechnicalEducation =
      this.onChangeTechnicalEducation.bind(this);
        ...
        this.setState({
          trainee: {
            ...
            identificationDetails: {
              ...
              guardianContactNumber:
                response.data.trainee.guardianContactNumber,
            },
            sourceOfHouseholdIncome:
            ...
            preTrainingDetails: {
              ...
              mobilisationTechnique:
                response.data.trainee.mobilisationTechnique,
            },
